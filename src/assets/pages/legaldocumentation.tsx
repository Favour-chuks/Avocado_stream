    ...
    <>
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-4 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <h2 className="mt-10 underline text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">
            Terms and Conditions
          </h2>
        </div>
        <div className="sm:mx-auto sm:w-full sm:max-w-2xl">
          <p className="mt-4 text-center text-md text-justify tracking-tight text-gray-900">
            ...
            pariatur?" 1914 translation by H. Rackham "But I must explain to
